...
public class Chunk {
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		if(var8 == var4 && this.data.get(var1, var2, var3) == var5) {
			...
			if(var8 != 0 && !this.worldObj.multiplayerWorld) {
				Block.blockList[var8].onBlockRemoval(this.worldObj, var9, var2, var10);
			}
			...
			if(var4 != 0) {
				Block.blockList[var4].onBlockAdded(this.worldObj, var9, var2, var10);
			}
	...
	public boolean setBlockID(int var1, int var2, int var3, int var4) {
		...
		if(var7 == var4) {
			...
			if(var7 != 0) {
				Block.blockList[var7].onBlockRemoval(this.worldObj, var8, var2, var9);
			}
			...
			if(var4 != 0 && !this.worldObj.multiplayerWorld) {
				Block.blockList[var4].onBlockAdded(this.worldObj, var8, var2, var9);
			}
	...
	public TileEntity getChunkBlockTileEntity(int var1, int var2, int var3) {
		...
		if(var5 == null) {
			...
			BlockContainer var7 = (BlockContainer)Block.blockList[var6];
	...
	public void setChunkBlockTileEntity(int var1, int var2, int var3, TileEntity var4) {
		...
		if(this.getBlockID(var1, var2, var3) != 0 && Block.blockList[this.getBlockID(var1, var2, var3)] instanceof BlockContainer) {
