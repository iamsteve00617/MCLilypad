...
public class World implements IBlockAccess {
	...
	private boolean getInitialSpawnLocation(int var1, int var2) {
	...
	public void saveWorld(boolean var1, IProgressUpdate var2) {
		if(this.chunkProvider.canSave()) {
			...
			this.saveLevel();
			if(var2 != null) {
				var2.resetProgressAndWorkingMessage("Saving chunks");
			}
	...
	public Material getBlockMaterial(int var1, int var2, int var3) {
		...
		return var4 == 0 ? Material.air : Block.blockList[var4].material;
	}
	...
	private void notifyBlockOfNeighborChange(int var1, int var2, int var3, int var4) {
		if(!this.editingBlocks && !this.multiplayerWorld) {
			Block var5 = Block.blockList[this.getBlockId(var1, var2, var3)];
			if(var5 != null) {
		...
		if(!Double.isNaN(var1.xCoord) && !Double.isNaN(var1.yCoord) && !Double.isNaN(var1.zCoord)) {
			if(!Double.isNaN(var2.xCoord) && !Double.isNaN(var2.yCoord) && !Double.isNaN(var2.zCoord)) {
				...
				while(var10-- >= 0) {
					...
					Block var33 = Block.blockList[var31];
	...
	public boolean spawnEntityInWorld(Entity var1) {
		...
		if(!var4 && !this.chunkExists(var2, var3)) {
			...
			this.getChunkFromChunkCoords(var2, var3).removeEntityAtIndex(var1);
			...
			for(int var10 = var7; var10 < var8; ++var10) {
				if(this.blockExists(var9, 64, var10)) {
					for(int var11 = var5 - 1; var11 < var6; ++var11) {
						Block var12 = Block.blockList[this.getBlockId(var9, var11, var10)];
						if(var12 != null) {
	...
	public int getTopSolidOrLiquidBlock(int var1, int var2) {
		...
		for(var2 &= 15; var4 > 0; --var4) {
			...
			if(var5 != 0 && (Block.blockList[var5].material.getIsSolid() || Block.blockList[var5].material.getIsLiquid())) {
				return var4 + 1;
			}
		}
	...
	public void scheduleBlockUpdate(int var1, int var2, int var3, int var4) {
		...
		if(this.checkChunksExist(var1 - var6, var2 - var6, var3 - var6, var1 + var6, var2 + var6, var3 + var6)) {
			if(var4 > 0) {
				var5.setScheduledTime((long)Block.blockList[var4].tickRate() + this.worldTime);
			}
		...
		if(this.checkChunksExist(var2 - var4, 0, var3 - var4, var2 + var4, 128, var3 + var4)) {
			...
			if(!var1.addedToChunk || var1.chunkCoordX != var5 || var1.chunkCoordY != var6 || var1.chunkCoordZ != var7) {
				...
				if(this.chunkExists(var5, var7)) {
					this.getChunkFromChunkCoords(var5, var7).removeEntityAtIndex(var1);
				} else {
		...
		for(int var8 = var2; var8 < var3; ++var8) {
			for(int var9 = var4; var9 < var5; ++var9) {
				for(int var10 = var6; var10 < var7; ++var10) {
					Block var11 = Block.blockList[this.getBlockId(var8, var9, var10)];
		...
		for(int var12 = var4; var12 < var5; ++var12) {
			for(int var13 = var6; var13 < var7; ++var13) {
				for(int var14 = var8; var14 < var9; ++var14) {
					Block var15 = Block.blockList[this.getBlockId(var12, var13, var14)];
		...
		for(int var9 = var3; var9 < var4; ++var9) {
			for(int var10 = var5; var10 < var6; ++var10) {
				for(int var11 = var7; var11 < var8; ++var11) {
					Block var12 = Block.blockList[this.getBlockId(var9, var10, var11)];
	...
	public boolean isBlockNormalCube(int var1, int var2, int var3) {
		Block var4 = Block.blockList[this.getBlockId(var1, var2, var3)];
		...
		while(var12.hasNext()) {
			...
			for(var6 = 0; var6 < 80; ++var6) {
				...
				if(Block.tickOnLoad[var15]) {
					Block.blockList[var15].updateTick(this, var8 + var3, var10, var9 + var4, this.rand);
				}
			}
		}
			...
			for(int var3 = 0; var3 < var2; ++var3) {
				...
				if(this.checkChunksExist(var4.xCoord - var5, var4.yCoord - var5, var4.zCoord - var5, var4.xCoord + var5, var4.yCoord + var5, var4.zCoord + var5)) {
					...
					if(var6 == var4.blockID && var6 > 0) {
						Block.blockList[var6].updateTick(this, var4.xCoord, var4.yCoord, var4.zCoord, this.rand);
					}
				}
			}
	...
	public boolean canBlockBePlacedAt(int var1, int var2, int var3, int var4, boolean var5) {
		int var6 = this.getBlockId(var2, var3, var4);
		Block var7 = Block.blockList[var6];
		Block var8 = Block.blockList[var1];
	...
	public boolean isBlockProvidingPowerTo(int var1, int var2, int var3, int var4) {
		...
		return var5 == 0 ? false : Block.blockList[var5].isIndirectlyPoweringTo(this, var1, var2, var3, var4);
	}
	...
	public boolean isBlockIndirectlyProvidingPowerTo(int var1, int var2, int var3, int var4) {
		if(this.isBlockNormalCube(var1, var2, var3)) {
			...
			int var5 = this.getBlockId(var1, var2, var3);
			return var5 == 0 ? false : Block.blockList[var5].isPoweringTo(this, var1, var2, var3, var4);
		}
	}
