...
public class TileEntityFurnace extends TileEntity implements IInventory {
	...
	private int getItemBurnTime(ItemStack var1) {
		if(var1 == null) {
			...
			return var2 < 256 && Block.blockList[var2].material == Material.wood ? 300 : (var2 == Item.stick.shiftedIndex ? 100 : (var2 == Item.coal.shiftedIndex ? 1600 : (var2 == Item.bucketLava.shiftedIndex ? 20000 : 0)));
		}
	}
}
