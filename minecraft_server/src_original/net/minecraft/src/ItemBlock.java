...
public class ItemBlock extends Item {
	...
	public ItemBlock(int var1) {
		...
		this.setIconIndex(Block.blockList[var1 + 256].getBlockTextureFromSide(2));
	}
	...
	public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7) {
		...
		if(var1.stackSize == 0) {
			...
			if(var3.canBlockBePlacedAt(this.blockID, var4, var5, var6, false)) {
				Block var8 = Block.blockList[this.blockID];
				if(var3.setBlockWithNotify(var4, var5, var6, this.blockID)) {
					Block.blockList[this.blockID].onBlockPlaced(var3, var4, var5, var6, var7);
