...
public class Block {
	...
	protected Block(int var1, Material var2) {
		...
		if(blockList[var1] != null) {
			throw new IllegalArgumentException("Slot " + var1 + " is already occupied by " + blockList[var1] + " when adding " + this);
		} else {
			this.material = var2;
			blockList[var1] = this;
			this.blockID = var1;
	...
	public boolean canPlaceBlockAt(World var1, int var2, int var3, int var4) {
		...
		return var5 == 0 || blockList[var5].material.getIsLiquid();
	}
