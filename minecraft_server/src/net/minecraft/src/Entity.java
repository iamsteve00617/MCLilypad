...
public abstract class Entity {
		...
		if(this.noClip) {
			...
			if(this.canTriggerWalking) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && var27 > 0) {
					...
					StepSound var28 = Block.blockList[var27].stepSound;
					...
					} else if(!Block.blockList[var27].material.getIsLiquid()) {
						this.worldObj.playSoundAtEntity(this, var28.getStepSound(), var28.getVolume() * 0.15F, var28.getPitch());
					}

					Block.blockList[var27].onEntityWalking(this.worldObj, var36, var25, var38, this);
				}
			}
			...
			for(int var30 = var36; var30 <= var27; ++var30) {
				for(int var31 = var25; var31 <= var39; ++var31) {
					for(int var32 = var38; var32 <= var29; ++var32) {
						...
						if(var33 > 0) {
							Block.blockList[var33].onEntityCollidedWithBlock(this.worldObj, var30, var31, var32, this);
						}
					}
				}
			}
	...
	public boolean isInsideOfMaterial(Material var1) {
		...
		if(var7 != 0 && Block.blockList[var7].material == var1) {
	...
	public void readFromNBT(NBTTagCompound var1) {
		...
		this.setPosition(0.0D, 0.0D, 0.0D);
		this.motionX = ((NBTTagDouble)var3.entities(0)).doubleValue;
		this.motionY = ((NBTTagDouble)var3.entities(1)).doubleValue;
		this.motionZ = ((NBTTagDouble)var3.entities(2)).doubleValue;
		this.prevPosX = this.lastTickPosX = this.posX = ((NBTTagDouble)var2.entities(0)).doubleValue;
		this.prevPosY = this.lastTickPosY = this.posY = ((NBTTagDouble)var2.entities(1)).doubleValue;
		this.prevPosZ = this.lastTickPosZ = this.posZ = ((NBTTagDouble)var2.entities(2)).doubleValue;
		this.prevRotationYaw = this.rotationYaw = ((NBTTagFloat)var4.entities(0)).floatValue;
		this.prevRotationPitch = this.rotationPitch = ((NBTTagFloat)var4.entities(1)).floatValue;
