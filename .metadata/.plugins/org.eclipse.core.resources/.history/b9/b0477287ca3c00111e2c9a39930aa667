...
public class GuiInventory extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float var1) {
		int var2 = this.b.renderEngine.getTexture("/gui/inventory.png");
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		this.b.renderEngine.bindTexture(var2);
		...
		float var6 = this.b.thePlayer.renderYawOffset;
		float var7 = this.b.thePlayer.rotationYaw;
		float var8 = this.b.thePlayer.rotationPitch;
		...
		this.b.thePlayer.renderYawOffset = (float)Math.atan((double)(var9 / 40.0F)) * 20.0F;
		this.b.thePlayer.rotationYaw = (float)Math.atan((double)(var9 / 40.0F)) * 40.0F;
		this.b.thePlayer.rotationPitch = -((float)Math.atan((double)(var10 / 40.0F))) * 20.0F;
		GL11.glTranslatef(0.0F, this.b.thePlayer.yOffset, 0.0F);
		RenderManager.instance.renderEntityWithPosYaw(this.b.thePlayer, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F);
		this.b.thePlayer.renderYawOffset = var6;
		this.b.thePlayer.rotationYaw = var7;
		this.b.thePlayer.rotationPitch = var8;
		GL11.glPopMatrix();
