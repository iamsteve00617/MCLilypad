...
public class GuiMainMenu extends GuiScreen {
	...
	protected void actionPerformed(GuiButton var1) {
		if(var1.id == 0) {
			this.b.displayGuiScreen(new GuiOptions(this, this.b.options));
		}

		if(var1.id == 1) {
			this.b.displayGuiScreen(new GuiSelectWorld(this));
		}

		if(var1.id == 2) {
			this.b.displayGuiScreen(new GuiMultiplayer(this));
		}
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		this.drawLogo(var3);
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.b.renderEngine.getTexture("/gui/logo.png"));
		...
		GL11.glPopMatrix();
		this.drawString(this.fontRenderer, "Copyright Mojang. Distribution strictly prohibited.", this.width - this.fontRenderer.getStringWidth("Copyright Mojang. Distribution strictly prohibited.") - 2, this.height - 10, 16777215);
		...
		if(!shw) {
			...
			this.b.displayGuiScreen(new ScreenInputPass(this.b));
		} else {
	...
	private void drawLogo(float var1) {
		...
		GL11.glPushMatrix();
		GL11.glLoadIdentity();
		var2 = 120 * (new ScaledResolution(this.b.displayWidth, this.b.displayHeight)).scaleFactor;
		GLU.gluPerspective(70.0F, (float)this.b.displayWidth / (float)var2, 0.05F, 100.0F);
		GL11.glViewport(0, this.b.displayHeight - var2, this.b.displayWidth, var2);
		...
		for(var3 = 0; var3 < 3; ++var3) {
			...
			if(var3 == 0) {
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.b.renderEngine.getTexture("/title/black.png"));
			}
			...
			for(int var5 = 0; var5 < this.logoBlockLayers.length; ++var5) {
				for(int var6 = 0; var6 < this.logoBlockLayers[var5].length(); ++var6) {
					if(this.logoBlockLayers[var5].charAt(var6) != 32) {
						...
						float var8 = (float)(var7.prevHeight + (var7.height - var7.prevHeight) * (double)var1);
						float var9 = 1.0F;
						float var10 = 1.0F;
						if(var3 == 0) {
		...
		GL11.glMatrixMode(GL11.GL_MODELVIEW);
		GL11.glPopMatrix();
		GL11.glViewport(0, 0, this.b.displayWidth, this.b.displayHeight);
