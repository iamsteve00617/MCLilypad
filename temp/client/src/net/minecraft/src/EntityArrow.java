...
public class EntityArrow extends Entity {
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.inData && this.shootingEntity == entityPlayer1 && this.arrowShake <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow.shiftedIndex, 1))) {
