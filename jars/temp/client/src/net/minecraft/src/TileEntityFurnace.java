...
public class TileEntityFurnace extends TileEntity implements IInventory {
	...
	public void updateEntity() {
		...
		if(this.furnaceBurnTime == 0 && this.canSmelt()) {
			int i3 = this.getItemBurnTime(this.furnaceItemStacks[1]);
			this.furnaceBurnTime = i3;
			this.currentItemBurnTime = i3;
			if(this.furnaceBurnTime > 0) {
				z2 = true;
				if(this.furnaceItemStacks[1] != null) {
					ItemStack itemStack4 = this.furnaceItemStacks[1];
	...
	private boolean canSmelt() {
		if(this.furnaceItemStacks[0] == null) {
			...
			return i1 >= 0 && (this.furnaceItemStacks[2] == null || this.furnaceItemStacks[2].itemID == i1 && (this.furnaceItemStacks[2].stackSize < this.getInventoryStackLimit() && this.furnaceItemStacks[2].stackSize < this.furnaceItemStacks[2].getMaxStackSize() || this.furnaceItemStacks[2].stackSize < Item.itemsList[i1].getItemStackLimit()));
		}
	}
	...
	public void smeltItem() {
		if(this.canSmelt()) {
			...
			if(this.furnaceItemStacks[2] == null) {
				...
				itemStack2 = this.furnaceItemStacks[2];
				++itemStack2.stackSize;
			}

			itemStack2 = this.furnaceItemStacks[0];
			--itemStack2.stackSize;
