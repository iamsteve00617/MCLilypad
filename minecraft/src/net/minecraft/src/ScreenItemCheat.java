		...
		if(var5 != 0 && var6 != 0) {
			...
			for(int var9 = 0; var9 != var5 * var6; ++var9) {
				...
				if(this.selectingBlocks) {
					...
					if(this.createButtons) {
						this.controlList.add(new LilypadBlockButton(2048 + var10, (int)var13, (int)var14, "", var10, this));
					}
					...
					if(this.createButtons) {
						this.controlList.add(new LilypadBlockButton(4096 + var10, (int)var17, (int)var13, "", var10, this));
					}
