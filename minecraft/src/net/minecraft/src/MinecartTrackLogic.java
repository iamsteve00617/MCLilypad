...
class MinecartTrackLogic {
	...
	public MinecartTrackLogic(ClassIf var1, World var2, int var3, int var4, int var5) {
		this.a = var1;
	...
	private boolean isMinecartTrack(int var1, int var2, int var3) {
		return this.worldObj.getBlockId(var1, var2, var3) == this.a.blockID || this.worldObj.getBlockId(var1, var2 + 1, var3) == this.a.blockID || this.worldObj.getBlockId(var1, var2 - 1, var3) == this.a.blockID;
	}

	private MinecartTrackLogic getMinecartTrackLogic(ChunkPosition var1) {
		return this.worldObj.getBlockId(var1.x, var1.y, var1.z) == this.a.blockID ? new MinecartTrackLogic(this.a, this.worldObj, var1.x, var1.y, var1.z) : (this.worldObj.getBlockId(var1.x, var1.y + 1, var1.z) == this.a.blockID ? new MinecartTrackLogic(this.a, this.worldObj, var1.x, var1.y + 1, var1.z) : (this.worldObj.getBlockId(var1.x, var1.y - 1, var1.z) == this.a.blockID ? new MinecartTrackLogic(this.a, this.worldObj, var1.x, var1.y - 1, var1.z) : null));
	}
	...
	private boolean canConnectTo(MinecartTrackLogic var1) {
		if(this.isConnectedTo(var1)) {
			...
			if(var1.trackY == this.trackY && var2.y == this.trackY) {
			}
