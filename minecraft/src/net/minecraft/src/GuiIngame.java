...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if(this.mc.playerController.shouldDrawHUD()) {
			...
			if(this.mc.thePlayer.dashTimer != 0) {
				this.drawGradientRect(var6 / 2 - 50 - 1, var7 - 90 - 1, var6 / 2 - 50 + 100 + 1, var7 - 90 + 5 + 1, -14671840, -16777216);
			...
			if(this.mc.theWorld.bossfightInProgress) {
				this.drawGradientRect(var6 / 2 - 150 - 1, 59, var6 / 2 - 150 + 301, 66, -14671840, -16777216);
				...
				var8.drawStringWithShadow(this.mc.theWorld.bossname, var6 / 2 - 150 - 1, 65, 16777215);
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/gui/icons.png"));
			}
		...
		for(var13 = 0; var13 < 9; ++var13) {
			this.renderInventorySlot(var13, var6 / 2 - 90 + var13 * 20 + 2, var7 - 16 - 3, var1);
		}

		GLStatics.a();
		GL11.glDisable(GL12.GL_RESCALE_NORMAL);
		if(this.mc.options.d) {
			var8.drawStringWithShadow("Minecraft Lilypad v1.0", 2, 2, 16777215);
			...
			if(this.mc.theWorld != null) {
				var8.drawStringWithShadow(Long.toString(this.mc.theWorld.randomSeed), 2, 52, 16777215);
			}

			if(uqKey != "") {
				var8.drawStringWithShadow(uqKey, 2, 52, 16777215);
			}
			...
			var8.drawStringWithShadow("Minecraft Alpha 1.0.16.05_13 Lilypad v1.0 ", 2, 2, 16777215);
			if(uqKey != "") {
				var8.drawStringWithShadow(uqKey, 2, 12, 16777215);
			}
		}
		...
		if(var14 != 0) {
			var8.drawStringWithShadow(this.currentArea, var6 / 2 - 80, 20, 16777215 + var14 * 16777216);
		}

		GL11.glPopMatrix();
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/gui/icons.png"));
		if(this.recordPlayingUpFor > 0) {
			float var28 = (float)this.recordPlayingUpFor - var1;
			...
			if(var16 > 0) {
				...
				var8.drawString(this.recordPlaying, -var8.getStringWidth(this.recordPlaying) / 2, -4, (Color.HSBtoRGB(var28 / 50.0F, 0.7F, 0.6F) & 16777215) + (var16 << 24));
				GL11.glDisable(GL11.GL_BLEND);
				GL11.glPopMatrix();
			}
		}
		...
		for(var30 = 0; var30 < this.chatMessageList.size() && var30 < var29; ++var30) {
			if(((ChatLine)this.chatMessageList.get(var30)).updateCounter < 200 || var34) {
				...
				if(var20 > 0) {
					...
					GL11.glEnable(GL11.GL_BLEND);
					var8.drawStringWithShadow(var23, 2, var22, 16777215 + (var20 << 24));
				}
			}
		}
		/*
	...
	private void renderVignette(float var1, int var2, int var3) {
		...
		this.prevVignetteBrightness += (float)((double)(var1 - this.prevVignetteBrightness) * 0.01D);
