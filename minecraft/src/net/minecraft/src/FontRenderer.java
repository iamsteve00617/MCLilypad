...
public class FontRenderer {
	...
	public FontRenderer(GameSettings var1, String var2, RenderEngine var3) {
		...
		for(var9 = 0; var9 < 256; ++var9) {
			...
			var10 = var9 % 16 * 8;
			var11 = var9 / 16 * 8;
			var19.addVertexWithUV(0.0D, (double)7.99F, 0.0D, (double)((float)var10 / 128.0F + 0.0F), (double)(((float)var11 + 7.99F) / 128.0F + 0.0F));
			var19.addVertexWithUV((double)7.99F, (double)7.99F, 0.0D, (double)(((float)var10 + 7.99F) / 128.0F + 0.0F), (double)(((float)var11 + 7.99F) / 128.0F + 0.0F));
			var19.addVertexWithUV((double)7.99F, 0.0D, 0.0D, (double)(((float)var10 + 7.99F) / 128.0F + 0.0F), (double)((float)var11 / 128.0F + 0.0F));
