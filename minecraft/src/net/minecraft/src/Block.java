...
public class Block {
	...
	public static final Block dbg2Block = (new BlockGlowing(113, 150, 1)).setHardness(0.0F).setLightValue(15.0F / 16.0F).setStepSound(soundStoneFootstep);
	public static final Block saltBlock = (new BlockMultiSided(114, 170, 169, 170)).setHardness(0.6F).setStepSound(soundStoneFootstep);
	public static final Block glowingFlower = (new BlockGlowingFlower(115, 171, 1)).setHardness(0.0F).setLightValue(15.0F / 16.0F).setStepSound(soundGrassFootstep);
	public static final Block glowingFlowerInfBasic = (new BlockGlowingFlowerInfused(117, 173, 1, 2)).setHardness(0.0F).setLightValue(15.0F / 16.0F).setStepSound(soundGrassFootstep);
	public static final Block glowingFlowerInfGold = (new BlockGlowingFlowerInfused(118, 174, 1, 4)).setHardness(0.0F).setLightValue(15.0F / 16.0F).setStepSound(soundGrassFootstep);
	public static final Block glowingFlowerInfObsidian = (new BlockGlowingFlowerInfused(119, 175, 1, 7)).setHardness(0.0F).setLightValue(15.0F / 16.0F).setStepSound(soundGrassFootstep);
	public static final Block blueFireIdk = (new BlockGlowing(116, 172, 2)).setHardness(0.0F).setLightValue(15.0F / 16.0F).setStepSound(soundStoneFootstep);
	...
	public float blockStrength(EntityPlayer var1) {
		return this.hardness < 0.0F ? (var1.inventory.getCurrentItem() != null && var1.inventory.getCurrentItem().getItem() == Item.obsidianPick ? var1.getCurrentPlayerStrVsBlock(this) / 2.0F / 30.0F : 0.0F) : (!var1.canHarvestBlock(this) ? 1.0F / this.hardness / 100.0F : var1.getCurrentPlayerStrVsBlock(this) / this.hardness / 30.0F);
	}
