...
public abstract class GuiContainer extends GuiScreen {
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		InventoryPlayer var10 = this.b.thePlayer.inventory;
		if(var10.draggedItemStack != null) {
			GL11.glTranslatef(0.0F, 0.0F, 32.0F);
			itemRenderer.renderItemIntoGUI(this.fontRenderer, this.b.renderEngine, var10.draggedItemStack, var1 - var4 - 8, var2 - var5 - 8);
			itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.b.renderEngine, var10.draggedItemStack, var1 - var4 - 8, var2 - var5 - 8);
		}
	...
	private void drawSlotInventory(SlotInventory var1) {
		...
		if(var6 == null) {
			...
			if(var7 >= 0) {
				GL11.glDisable(GL11.GL_LIGHTING);
				this.b.renderEngine.bindTexture(this.b.renderEngine.getTexture("/gui/items.png"));
		...
		itemRenderer.renderItemIntoGUI(this.fontRenderer, this.b.renderEngine, var6, var4, var5);
		itemRenderer.renderItemOverlayIntoGUI(this.fontRenderer, this.b.renderEngine, var6, var4, var5);
	}
	...
	protected void mouseClicked(int var1, int var2, int var3) {
		if(var3 == 0 || var3 == 1) {
			...
			InventoryPlayer var5 = this.b.thePlayer.inventory;
			int var7;
			if(var4 != null) {
				...
				if(var1 < var9 || var2 < var7 || var1 >= var9 + this.xSize || var2 >= var7 + this.xSize) {
					EntityPlayerSP var8 = this.b.thePlayer;
					if(var3 == 0) {
	...
	protected void keyTyped(char var1, int var2) {
		if(var2 == 1 || var2 == this.b.options.keyBindInventory.keyCode) {
	...
	public void onGuiClosed() {
		InventoryPlayer var1 = this.b.thePlayer.inventory;
		if(var1.draggedItemStack != null) {
			this.b.thePlayer.dropPlayerItem(var1.draggedItemStack);
