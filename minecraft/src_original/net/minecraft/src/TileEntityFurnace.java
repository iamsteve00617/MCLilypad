...
public class TileEntityFurnace extends TileEntity implements IInventory {
	...
	private int getCookedItem(int var1) {
		return var1 == Block.oreIron.blockID ? Item.ingotIron.shiftedIndex : (var1 == Block.oreGold.blockID ? Item.ingotGold.shiftedIndex : (var1 == Block.oreDiamond.blockID ? Item.diamond.shiftedIndex : (var1 == Block.sand.blockID ? Block.glass.blockID : (var1 == Item.porkRaw.shiftedIndex ? Item.porkCooked.shiftedIndex : (var1 == Block.cobblestone.blockID ? Block.stone.blockID : (var1 == Item.clay.shiftedIndex ? Item.brick.shiftedIndex : (var1 == Block.obsidian.blockID ? Item.obsidianIngot.shiftedIndex : (var1 == Item.coal.shiftedIndex ? Item.blackDye.shiftedIndex : (var1 == Item.redstone.shiftedIndex ? Item.greenDye.shiftedIndex : (var1 == Block.plantYellow.blockID ? Item.blueDye.shiftedIndex : (var1 == Block.mushroomBrown.blockID ? Item.pinkDye.shiftedIndex : (var1 == Block.mushroomRed.blockID ? Item.fryshroom.shiftedIndex : -1))))))))))));
	}
