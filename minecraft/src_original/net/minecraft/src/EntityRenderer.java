...
public class EntityRenderer {
	...
	private void setupCameraTransform(float var1, int var2) {
		...
		GLU.gluPerspective(this.getFOVModifier(var1), (float)this.mc.displayWidth / (float)this.mc.displayHeight, 0.05F, this.fl_i);
		...
		for(int var15 = var4 - var14; var15 <= var4 + var14; ++var15) {
			for(int var16 = var6 - var14; var16 <= var6 + var14; ++var16) {
				...
				if(var18 != var19) {
					...
					float var21 = (float)this.int_j + var1;
					float var22 = ((float)(this.int_j & 511) + var1) / 512.0F;
