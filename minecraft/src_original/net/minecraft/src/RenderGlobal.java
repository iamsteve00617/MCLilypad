...
public class RenderGlobal implements IWorldAccess {
	...
	public void renderSky(float var1) {
		...
		var13.draw();
		GL11.glDisable(GL11.GL_TEXTURE_2D);
		float var12 = this.theWorld.getStarBrightness(var1);
		if(var12 > 0.0F) {
		...
		if(this.mc.options.fancyGraphics) {
			...
			for(int var24 = -256; var24 < 256; var24 += 32) {
				for(int var25 = -256; var25 < 256; var25 += 32) {
					var5.addVertexWithUV((double)(var24 + 0), (double)var21, (double)(var25 + 32), (double)((float)(var24 + 0) * (0.5F / 1024.0F) + var22), (double)((float)(var25 + 32) * (0.5F / 1024.0F) + var23));
					var5.addVertexWithUV((double)(var24 + 32), (double)var21, (double)(var25 + 32), (double)((float)(var24 + 32) * (0.5F / 1024.0F) + var22), (double)((float)(var25 + 32) * (0.5F / 1024.0F) + var23));
					var5.addVertexWithUV((double)(var24 + 32), (double)var21, (double)(var25 + 0), (double)((float)(var24 + 32) * (0.5F / 1024.0F) + var22), (double)((float)(var25 + 0) * (0.5F / 1024.0F) + var23));
					var5.addVertexWithUV((double)(var24 + 0), (double)var21, (double)(var25 + 0), (double)((float)(var24 + 0) * (0.5F / 1024.0F) + var22), (double)((float)(var25 + 0) * (0.5F / 1024.0F) + var23));
				}
			}
			...
			for(int var32 = -2; var32 <= 3; ++var32) {
				for(int var33 = -2; var33 <= 3; ++var33) {
					...
					if(var10 <= 5.0F) {
						...
						var3.setNormal(0.0F, 1.0F, 0.0F);
						var3.addVertexWithUV((double)(var36 + 0.0F), (double)(var10 + 4.0F - 1.0F / 1024.0F), (double)(var37 + 8.0F), (double)((var34 + 0.0F) * 0.00390625F + var24), (double)((var35 + 8.0F) * 0.00390625F + var25));
						var3.addVertexWithUV((double)(var36 + 8.0F), (double)(var10 + 4.0F - 1.0F / 1024.0F), (double)(var37 + 8.0F), (double)((var34 + 8.0F) * 0.00390625F + var24), (double)((var35 + 8.0F) * 0.00390625F + var25));
						var3.addVertexWithUV((double)(var36 + 8.0F), (double)(var10 + 4.0F - 1.0F / 1024.0F), (double)(var37 + 0.0F), (double)((var34 + 8.0F) * 0.00390625F + var24), (double)((var35 + 0.0F) * 0.00390625F + var25));
						var3.addVertexWithUV((double)(var36 + 0.0F), (double)(var10 + 4.0F - 1.0F / 1024.0F), (double)(var37 + 0.0F), (double)((var34 + 0.0F) * 0.00390625F + var24), (double)((var35 + 0.0F) * 0.00390625F + var25));
					}
					...
					if(var32 <= 1) {
						...
						for(var38 = 0; var38 < 8; ++var38) {
							var3.addVertexWithUV((double)(var36 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)(var10 + 0.0F), (double)(var37 + 8.0F), (double)((var34 + (float)var38 + 0.5F) * 0.00390625F + var24), (double)((var35 + 8.0F) * 0.00390625F + var25));
							var3.addVertexWithUV((double)(var36 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)(var10 + 4.0F), (double)(var37 + 8.0F), (double)((var34 + (float)var38 + 0.5F) * 0.00390625F + var24), (double)((var35 + 8.0F) * 0.00390625F + var25));
							var3.addVertexWithUV((double)(var36 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)(var10 + 4.0F), (double)(var37 + 0.0F), (double)((var34 + (float)var38 + 0.5F) * 0.00390625F + var24), (double)((var35 + 0.0F) * 0.00390625F + var25));
							var3.addVertexWithUV((double)(var36 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)(var10 + 0.0F), (double)(var37 + 0.0F), (double)((var34 + (float)var38 + 0.5F) * 0.00390625F + var24), (double)((var35 + 0.0F) * 0.00390625F + var25));
						}
					}
					...
					if(var33 <= 1) {
						...
						for(var38 = 0; var38 < 8; ++var38) {
							var3.addVertexWithUV((double)(var36 + 0.0F), (double)(var10 + 4.0F), (double)(var37 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)((var34 + 0.0F) * 0.00390625F + var24), (double)((var35 + (float)var38 + 0.5F) * 0.00390625F + var25));
							var3.addVertexWithUV((double)(var36 + 8.0F), (double)(var10 + 4.0F), (double)(var37 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)((var34 + 8.0F) * 0.00390625F + var24), (double)((var35 + (float)var38 + 0.5F) * 0.00390625F + var25));
							var3.addVertexWithUV((double)(var36 + 8.0F), (double)(var10 + 0.0F), (double)(var37 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)((var34 + 8.0F) * 0.00390625F + var24), (double)((var35 + (float)var38 + 0.5F) * 0.00390625F + var25));
							var3.addVertexWithUV((double)(var36 + 0.0F), (double)(var10 + 0.0F), (double)(var37 + (float)var38 + 1.0F - 1.0F / 1024.0F), (double)((var34 + 0.0F) * 0.00390625F + var24), (double)((var35 + (float)var38 + 0.5F) * 0.00390625F + var25));
						}
					}
