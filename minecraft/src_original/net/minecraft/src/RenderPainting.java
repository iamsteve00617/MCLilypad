	...
	private void setSizes(EntityPainting var1, int var2, int var3, int var4, int var5) {
		...
		for(int var10 = 0; var10 < var2 / 16; ++var10) {
			for(int var11 = 0; var11 < var3 / 16; ++var11) {
				...
				var32.addVertexWithUV((double)var13, (double)var15, 0.5D, 0.8125D, 1.0D / 16.0D);
				var32.addVertexWithUV((double)var12, (double)var15, 0.5D, 0.75D, 1.0D / 16.0D);
				var32.setNormal(0.0F, -1.0F, 0.0F);
				var32.addVertexWithUV((double)var12, (double)var14, -0.5D, 0.75D, 1.0D / 512.0D);
				var32.addVertexWithUV((double)var13, (double)var14, -0.5D, 0.8125D, 1.0D / 512.0D);
				var32.addVertexWithUV((double)var13, (double)var14, 0.5D, 0.8125D, 1.0D / 512.0D);
				var32.addVertexWithUV((double)var12, (double)var14, 0.5D, 0.75D, 1.0D / 512.0D);
				var32.setNormal(0.0F, 1.0F, 0.0F);
				var32.addVertexWithUV((double)var12, (double)var15, 0.5D, 0.75D, 1.0D / 512.0D);
				var32.addVertexWithUV((double)var13, (double)var15, 0.5D, 0.8125D, 1.0D / 512.0D);
				var32.addVertexWithUV((double)var13, (double)var15, -0.5D, 0.8125D, 1.0D / 512.0D);
				var32.addVertexWithUV((double)var12, (double)var15, -0.5D, 0.75D, 1.0D / 512.0D);
				var32.setNormal(-1.0F, 0.0F, 0.0F);
				var32.addVertexWithUV((double)var12, (double)var14, 0.5D, (double)0.7519531F, 0.0D);
				var32.addVertexWithUV((double)var12, (double)var15, 0.5D, (double)0.7519531F, 1.0D / 16.0D);
				var32.addVertexWithUV((double)var12, (double)var15, -0.5D, (double)0.7519531F, 1.0D / 16.0D);
				var32.addVertexWithUV((double)var12, (double)var14, -0.5D, (double)0.7519531F, 0.0D);
				var32.setNormal(1.0F, 0.0F, 0.0F);
				var32.addVertexWithUV((double)var13, (double)var14, -0.5D, (double)0.7519531F, 0.0D);
				var32.addVertexWithUV((double)var13, (double)var15, -0.5D, (double)0.7519531F, 1.0D / 16.0D);
				var32.addVertexWithUV((double)var13, (double)var15, 0.5D, (double)0.7519531F, 1.0D / 16.0D);
				var32.addVertexWithUV((double)var13, (double)var14, 0.5D, (double)0.7519531F, 0.0D);
				var32.draw();
			}
