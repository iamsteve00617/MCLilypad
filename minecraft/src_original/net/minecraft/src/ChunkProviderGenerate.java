...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void replaceSurfaceBlocks(int var1, int var2, byte[] var3) {
		this.sandNoise = this.noiseGen4.generateNoiseOctaves(this.sandNoise, (double)(var1 * 16), (double)(var2 * 16), 0.0D, 16, 16, 1, 1.0D / 32.0D, 1.0D / 32.0D, 1.0D);
		this.gravelNoise = this.noiseGen4.generateNoiseOctaves(this.gravelNoise, (double)(var2 * 16), 109.0134D, (double)(var1 * 16), 16, 1, 16, 1.0D / 32.0D, 1.0D, 1.0D / 32.0D);
		this.stoneNoise = this.noiseGen5.generateNoiseOctaves(this.stoneNoise, (double)(var1 * 16), (double)(var2 * 16), 0.0D, 16, 16, 1, 1.0D / 16.0D, 1.0D / 16.0D, 1.0D / 16.0D);
